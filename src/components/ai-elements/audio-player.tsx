...
export const AudioPlayerElement = forwardRef<
  HTMLAudioElement,
  AudioPlayerElementProps
>(function AudioPlayerElement(props, ref) {
  if ("src" in props) {
...
export const AudioPlayerTimeDisplay = ({
  ...
  <MediaTimeDisplay
    className={cn(
      "tabular-nums flex items-center gap-2 rounded-lg border border-transparent bg-transparent px-2.5 text-sm font-medium",
      className,
    )}
